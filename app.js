...
function openProductModal(catId,itemIndex){
  ...
  $('#modalThumb').style.backgroundImage=`url('assets/heroes/${c.image}')`;$('#modalCategory').textContent=nameOf(c);$('#modalName').textContent=state.lang==='ar'?i[1]:i[0];$('#modalPrice').textContent=money(i[2]);$('#modalQty').textContent='1';$('#itemNote').value='';
